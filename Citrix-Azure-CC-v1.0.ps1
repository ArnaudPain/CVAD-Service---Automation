...
<#
.SYNOPSIS
	Deploy 2 Windows Server 2016 on Azure, domin join and deploy Citrix Cloud Connector in Azure
.DESCRIPTION
	The script will create Resource Location in Citrix Cloud.
	It will deploy 2 VMs in Azure based on Windows Server 2016 Template (if you want to use Windows Server 2019, just change line 46 and replace 2016 with 2019
...
# Valid Azure specifics
    $AzureResourceGroupLocation = "EastUS2"
    $AzureVNetName = "" # To be filled before running the script and must have domain controller on network
    $AzureSubnetName = "Default"
# Azure specifics - Will be created if needed
    $AzureResourceGroupName = "" # To be filled before running the script
    $AzureVNetResourceGroupName = "" # To be filled before running the script
    $AzureDiagnosticsStorageAccountName = "" # To be filled before running the script and must be all lower case
    $AzureDiagnosticResourceGroupName = "" # To be filled before running the script
# Miscellaneous
    $DomainName = "" # To be filled before running the script
# Citrix Cloud Information
    $CTX_Resource_Location_Name = "" # To be filled before running the script
# Azure specific
    $AzureStorageAccountName = "" # To be filled before running the script and must be all lower case
    $CloudConnectorDeploymentTemplateFile = "https://raw.githubusercontent.com/ArnaudPain/CVAD-Service---Automation/master/Azure-Citrix-Cloud-Connector-Deployment-Template-2016.json"
...
# Citrix Delivery controller
    $DDC= "" # To be filled before running the script
